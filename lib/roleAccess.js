...
export const ROUTE_ACCESS = {
  ...
  // Resident routes
  '/Facilities': [ROLES.HOUSE_OWNER, ROLES.SOCIETY_MEMBER, ROLES.TENANT, ROLES.RESIDENT, ROLES.SOCIETY_ADMIN, ROLES.SOCIETY_SECRETARY, ROLES.SUPER_ADMIN],
  ...
  '/dashboard/visitor': [ROLES.HOUSE_OWNER, ROLES.SOCIETY_MEMBER, ROLES.TENANT, ROLES.RESIDENT, ROLES.SOCIETY_ADMIN, ROLES.SOCIETY_SECRETARY, ROLES.SUPER_ADMIN],
  ...
  '/watchman-logs': [ROLES.WATCHMAN, ROLES.SOCIETY_SECRETARY, ROLES.SOCIETY_ADMIN, ROLES.SUPER_ADMIN],
...
export function getUserCapabilities(userRole) {
  const capabilities = {
    ...
    canManageVisitors: [ROLES.HOUSE_OWNER, ROLES.SOCIETY_MEMBER, ROLES.TENANT, ROLES.RESIDENT, ROLES.WATCHMAN, ROLES.SOCIETY_SECRETARY, ROLES.SOCIETY_ADMIN, ROLES.SUPER_ADMIN].includes(userRole),
    canBookFacilities: [ROLES.HOUSE_OWNER, ROLES.SOCIETY_MEMBER, ROLES.TENANT, ROLES.RESIDENT, ROLES.SOCIETY_ADMIN, ROLES.SOCIETY_SECRETARY, ROLES.SUPER_ADMIN].includes(userRole),
    canViewActivityLogs: [ROLES.WATCHMAN, ROLES.SOCIETY_SECRETARY, ROLES.SOCIETY_ADMIN, ROLES.SUPER_ADMIN].includes(userRole),
    ...
    isAdmin: [ROLES.SOCIETY_ADMIN, ROLES.SOCIETY_SECRETARY, ROLES.SUPER_ADMIN].includes(userRole)
  };
